...
# Stats
from scipy import stats                                                                    # stats.randint works — no separate randint line needed
import statsmodels.formula.api as smf                                                     # smf.ols works — dropped separate ols import
...
from imblearn.pipeline import Pipeline  # imblearn Pipeline replaces sklearn's — handles SMOTE correctly
